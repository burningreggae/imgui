...
namespace ImGui
{
    ...
    IMGUI_API void          Columns(int count = 1, const char* id = NULL, bool border = true, ImGuiItemGetter items_getter = 0, void *data = 0);
    ...
    IMGUI_API bool          Combo(const char* label, int* current_item, ImGuiItemGetter items_getter, void* data, int items_count, int height_in_items = -1);
...
enum ImGuiWindowFlags_
{
	...
	ImGuiWindowFlags_NoShadows				= 1 << 18,  // Disable Shadows
...
struct ImDrawCmd
{
    ...
    shaderparam *shader;
	float envelope;
    ImDrawCmd() { ElemCount = 0; ClipRect.x = ClipRect.y = -8192.0f; ClipRect.z = ClipRect.w = +8192.0f; TextureId = NULL; UserCallback = NULL; UserCallbackData = NULL; shader = NULL; envelope = 1.f; }
};
