...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Combo"))
        {
            ...
            struct FuncHolder { static bool ItemGetter(void* data, int idx, const char** out_str,ImGuiItemGetterCommand cmd) { *out_str = ((const char**)data)[idx]; return true; } };
    ...
    if (ImGui::CollapsingHeader("Stack Layout"))
    {
        ...
        static float middleWeight = 0.5f;
        static float centerWeight = 0.5f;
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::TreeNode("Settings"))
    {
        ...
        ImGui::SliderFloat("ScrollbarSize", &style.ScrollbarSize, 1.0f, 40.0f, "%.0f");
