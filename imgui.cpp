...
bool ImGui::TreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end)
{
    ...
    if (display_frame)
    {
        ...
        RenderTriangle(frame_bb.Min + ImVec2(padding.x, frame_bb.GetHeight()*0.5f), is_open ? ImGuiDir_Down : ImGuiDir_Right, 1.0f);
    ...
    else
    {
        ...
        if (flags & ImGuiTreeNodeFlags_Bullet)
            ...
            RenderTriangle(frame_bb.Min + ImVec2(padding.x,frame_bb.GetHeight()*0.5f), is_open ? ImGuiDir_Down : ImGuiDir_Right, 0.70f);
        if (g.LogEnabled)
...
bool ImGui::BeginMenu(const char* label, bool enabled)
{
    ...
    else
    {
        ...
        RenderTriangle(pos + ImVec2(window->MenuColumns.Pos[2] + extra_w + g.FontSize * 0.30f, label_size.y*0.5f), ImGuiDir_Right);
