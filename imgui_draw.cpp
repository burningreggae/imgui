...
void ImDrawList::AddPolyline(const ImVec2* points, const int points_count, ImU32 col, bool closed, float thickness, bool anti_aliased,const float* _primitiveRestartIndex)
{
    if (points_count < 2)
        return;
...
void ImDrawList::PathArcToFast(const ImVec2& centre, float radius, int amin, int amax)
{
    ...
    else
    {
        ...
        {
            const ImVec2& c = circle_vtx[(a*circle_supersample) & 0x1f]; //% circle_vtx_count];
